...
// KURIO adaptation: default = bg-primary + text-primary-foreground. Uso do
// contador do carrinho (spec §2): `<Badge className="size-4 text-tiny-10
// font-medium">` no call-site (16x16, 10px) — não um size próprio aqui.
