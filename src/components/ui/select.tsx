...
// KURIO adaptation: trigger igual ao input (rounded-lg, border-input,
// bg-transparent).
...
// KURIO adaptation: content bg-popover (= surface-card), border-border
// (herdado do `* { @apply border-border }` global), rounded-lg.
