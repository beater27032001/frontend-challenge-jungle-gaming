...
// KURIO adaptation: overlay bg-ink/80 (spec: "dialog | overlay bg-ink/80").
...
// KURIO adaptation: content bg-card border rounded-lg. Focus trap/Esc são
// nativos do Radix — nenhum código extra é necessário aqui.
