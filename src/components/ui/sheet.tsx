...
// KURIO adaptation: idem dialog (overlay bg-ink/80, content bg-card); `side`
// configurável. Este é o "drawer" do desafio (painel lateral com focus trap
// nativo do Radix Dialog) — sem consumidor na fase 2 (spec §10 eliminou o
// drawer de navegação mobile); a fase 3 o usa para o filtro mobile.
...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-ink/80 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0",
        className
      )}
      {...props}
    />
